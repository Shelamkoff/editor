...
function removeAllScriptTags(range) {
  // For cross-block ranges, walk from commonAncestorContainer
  // to find all sup/sub tags across all affected blocks.
  ...
  const tags = root.querySelectorAll('sup, sub')
    ...
    renderActions(ctx) {
      ...
      for (const mode of modes) {
        ...
        btn.addEventListener('click', (e) => {
          ...
          // Restore selection after close (so toolbar stays visible)
