...
Канонический контракт сохраняемых данных, общий для редактора и рендерера, приведён в [справочнике полей плагина предпросмотра ссылки](/ru/reference/editor/plugins/link-preview#поля-данных).
