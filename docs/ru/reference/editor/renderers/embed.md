...
Канонический контракт сохраняемых данных, общий для редактора и рендерера, приведён в [справочнике полей плагина встраиваемого содержимого](/ru/reference/editor/plugins/embed#поля-данных).
