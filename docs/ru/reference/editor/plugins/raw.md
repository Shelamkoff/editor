...
На поверхности редактирования HTML остаётся неактивным. Соответствующий рендерер очищает его до добавления в DOM; политика доверия приложения остаётся ответственностью потребителя.
...
Редактирование исходного текста; изолированный предварительный просмотр; очищенный итоговый DOM.
