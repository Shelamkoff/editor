...
Точка входа включает разметку редактора, CSS встроенных плагинов и переменные светлой и тёмной тем. Возможность со стилями из другого пакета указывает дополнительный импорт на своей странице. Например, для выбора цвета нужен:
