...
The [link-preview plugin field reference](/reference/editor/plugins/link-preview#field-reference) is the canonical persisted-data contract shared by the editor and renderer.
