...
Полный контракт сохранённых данных и текущих результатов описан в [справочнике полей плагина Poll](../../../plugins/poll/README.ru.md#поля-данных).
...
| `onError` | Необязательный обработчик ошибок загрузки, голосования, подписки, очистки или сравнения ревизий. Он может вернуть `Promise`; синхронные исключения и отклонения `Promise` изолируются. Рендерер также показывает локализованное состояние ошибки. |
