...
Полный контракт сохранённых данных, включая раскладки, значения по умолчанию и ограничения проверки, описан в [справочнике полей плагина Gallery](../../../plugins/gallery/README.ru.md#поля-данных).
